...
export default function Home() {
  ...
  <div className="container">
    <div className="welcome-section">
      ...
      <p>
        🌿 Bienvenue sur Crafty 🌿<br />
        Votre boutique écoresponsable dédiée à des produits artisanaux et durables. 🌍✨<br />
        📦 Achetez en soutenant des créateurs locaux<br />
        ♻️ Choisissez la qualité, respectueuse de la planète<br />
        😊 Une expérience d'achat conviviale et engagée<br />
        Crafty, votre partenaire pour consommer autrement.<br />
      </p>
    </div>
